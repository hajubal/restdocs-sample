...
import static com.example.demo.api.controller.document.utils.DocumentLinkGenerator.DocUrl.JOBV2;
...
public class UnitUpdateV2DocumentationTests extends ApiDocumentationTest {
    ...
    public void update() throws Exception {
        ...
        result.andExpect(status().isOk())
                .andDo(document("units-update-v2",
                        ...
                        requestFields(
                                fieldWithPath("job").type(JsonFieldType.STRING).description(generateLinkCode(JOBV2)),
